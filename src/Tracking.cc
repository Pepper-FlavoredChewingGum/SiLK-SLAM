...
void Tracking::Track()
{
    ...
    else
    {
        ...
        if(!mbOnlyTracking)
        {
            ...
            // 跟踪进入正常SLAM模式，有地图更新
//             if(Lost_sign_1&&mCurrentFrame.mnId==100&&mCurrentFrame.mTimeStamp-mTimeStampLost>0.5){
//                 mTimeStampLost = mCurrentFrame.mTimeStamp;
//                 mState=RECENTLY_LOST;
//                 Lost_sign_1 = false;
//             }
//             if(Lost_sign_2&&mCurrentFrame.mnId==300&&mCurrentFrame.mTimeStamp-mTimeStampLost>0.5){
//                 mTimeStampLost = mCurrentFrame.mTimeStamp;
//                 mState=RECENTLY_LOST;
//                 Lost_sign_2 = false;
//             }
//             if(Lost_sign_3&&mCurrentFrame.mnId==500&&mCurrentFrame.mTimeStamp-mTimeStampLost>0.5){
//                 mTimeStampLost = mCurrentFrame.mTimeStamp;
//                 mState=RECENTLY_LOST;
//                 Lost_sign_3 = false;
//             }
//             if(Lost_sign_4&&mCurrentFrame.mnId==800&&mCurrentFrame.mTimeStamp-mTimeStampLost>0.5){
//                 mTimeStampLost = mCurrentFrame.mTimeStamp;
//                 mState=RECENTLY_LOST;
//                 Lost_sign_4 = false;
//             }
...
bool Tracking::NeedNewKeyFrame()
{
    ...
    const bool c1b = ((mCurrentFrame.mnId>=mnLastKeyFrameId+5) && bLocalMappingIdle); //mpLocalMapper->KeyframesInQueue() < 2);
...
{
    std::cout << "begin relocalization " << std::endl;
    ...
    for(int i=0; i<nKFs; i++)
    {
        ...
        else
        {
            ...
            std::cout << "nmatches: " << nmatches << endl;
            ...
            else
            {
                ...
                mParams = {mpCamera->getParameter(0), mpCamera->getParameter(1), mpCamera->getParameter(2), mpCamera->getParameter(3)};
                MLPnPsolver* pSolver = new MLPnPsolver(mCurrentFrame,vvpMapPointMatches[i], mParams);
                ...
                pSolver->SetRansacParameters(
                    ...
                    8,                      // 内点的最小阈值，默认8
                    300,                     // 最大迭代次数，默认300
                    8,                       // 最小集，每次采样六个点，即最小集应该设置为6，论文里面写着I > 5
                    0.4,                     // 理论最少内点个数，这里是按照总数的比例计算，所以epsilon是比例，默认是0.4
